                        ...
                        <div id="chat-scroll">
                          <ul class="chat-list list-unstyled m-b-0">
                            <li class="clearfix active">
                              <img src="assets-admin/img/users/user-4.png" alt="avatar">
                              <div class="about">
                            ...
                            <li class="clearfix ">
                              <img src="assets-admin/img/users/user-1.png" alt="avatar">
                              <div class="about">
                            ...
                            <li class="clearfix">
                              <img src="assets-admin/img/users/user-2.png" alt="avatar">
                              <div class="about">
                            ...
                            <li class="clearfix">
                              <img src="assets-admin/img/users/user-3.png" alt="avatar">
                              <div class="about">
                            ...
                            <li class="clearfix">
                              <img src="assets-admin/img/users/user-5.png" alt="avatar">
                              <div class="about">
...
<script src="{{ asset('assets-admin/js/page/chat.js') }}"></script>
<!-- Template JS File -->
