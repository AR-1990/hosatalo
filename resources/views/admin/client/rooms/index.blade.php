                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <a href="{{ route('admin.client.rooms.create') }}" class="btn btn-primary">
                        ...
                        <div class="card-body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group" role="group">
                                                            <a href="{{ route('admin.client.rooms.edit', $room->id) }}" 
                                                               class="btn btn-sm btn-info" title="Edit">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                            
                                                            <form action="{{ route('admin.client.rooms.toggle-availability', $room->id) }}" 
                                                                  method="POST" class="d-inline">
                                                                @csrf
                                                                @method('PATCH')
                                                                <button type="submit" class="btn btn-sm btn-warning" title="Toggle Availability">
                                                                    @if($room->is_available)
                                                            ...
                                                            <form action="{{ route('admin.client.rooms.destroy', $room->id) }}" 
                            ...
                            @else
                                <div class="text-center py-4">
                                    ...
                                    <p class="text-muted">You haven't added any rooms yet. Start by adding your first room!</p>
                                    <a href="{{ route('admin.client.rooms.create') }}" class="btn btn-primary">
