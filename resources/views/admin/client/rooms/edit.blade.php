    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="{{ route('admin.client.rooms') }}">Rooms</a></div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.client.rooms.update', $room->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                        ...
                                        <div class="col-md-3">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="amenity_shared_bathroom" name="amenities[]" value="Shared Bathroom"
                                                       {{ in_array('Shared Bathroom', old('amenities', $room->amenities ?? [])) ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label class="custom-control-label" for="is_available">Room is available for booking</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="{{ route('admin.client.rooms') }}" class="btn btn-secondary">
