                  ...
                  <div class="card-bg">
                    <div class="p-t-20 d-flex justify-content-between">
                      <div class="col">
                        ...
                        <span class="font-weight-bold mb-0 font-20">PKR 2,687</span>
                      </div>
                ...
                <div class="card card-statistic-1">
                  ...
                  <div class="card-wrap">
                    <div class="padding-20">
                      <div class="text-right">
                        <h3 class="font-light mb-0">
                          <i class="ti-arrow-up text-success"></i> PKR 5,263
                        </h3>
                  ...
                  <div class="card-body card-type-3">
                    <div class="row">
                      <div class="col">
                        ...
                        <span class="font-weight-bold mb-0">PKR 8,965</span>
                      </div>
                      <div class="col-auto">
                        ...
                        <div class="media-body">
                          ...
                          <div class="mt-1">
                            <div class="budget-price">
                              ...
                              <div class="budget-price-label">PKR 24,897</div>
                            </div>
                            <div class="budget-price">
                              <div class="budget-price-square bg-danger" data-width="38%"></div>
                              <div class="budget-price-label">PKR 18,865</div>
                            </div>
                          </div>
                        </div>
                      </li>
                        ...
                        <div class="media-body">
                          ...
                          <div class="mt-1">
                            <div class="budget-price">
                              ...
                              <div class="budget-price-label">PKR 74,568</div>
                            </div>
                            <div class="budget-price">
                              <div class="budget-price-square bg-danger" data-width="55%"></div>
                              <div class="budget-price-label">PKR 65,892</div>
                            </div>
                          </div>
                        </div>
                      </li>
                        ...
                        <div class="media-body">
                          ...
                          <div class="mt-1">
                            <div class="budget-price">
                              ...
                              <div class="budget-price-label">PKR 2,859</div>
                            </div>
                            <div class="budget-price">
                              <div class="budget-price-square bg-danger" data-width="25%"></div>
                              <div class="budget-price-label">PKR 1,872</div>
                            </div>
                          </div>
                        </div>
                      </li>
                        ...
                        <div class="media-body">
                          ...
                          <div class="mt-1">
                            <div class="budget-price">
                              ...
                              <div class="budget-price-label">PKR 11,238</div>
                            </div>
                            <div class="budget-price">
                              <div class="budget-price-square bg-danger" data-width="33%"></div>
                              <div class="budget-price-label">PKR 7,564</div>
                            </div>
                          </div>
                        </div>
                      </li>
                        ...
                        <div class="media-body">
                          ...
                          <div class="mt-1">
                            <div class="budget-price">
                              ...
                              <div class="budget-price-label">PKR 7,285</div>
                            </div>
                            <div class="budget-price">
                              <div class="budget-price-square bg-danger" data-width="74%"></div>
                              <div class="budget-price-label">PKR 5,147</div>
                            </div>
                          </div>
                        </div>
                      </li>
