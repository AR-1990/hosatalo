...
<!-- contact  21 Nov 2019 04:05:04 GMT -->
<head>
  <meta charset="UTF-8">
...
<script src="{{ asset('assets-admin/bundles/gmaps.js') }}"></script>
<!-- Page Specific JS File -->
<script src="{{ asset('assets-admin/js/page/contact.js') }}"></script>
<!-- Template JS File -->
...
<!-- contact  21 Nov 2019 04:05:05 GMT -->
</html>