                    ...
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          ...
                          <h2 class="mb-3 font-18">PKR 48,697</h2>
                  ...
                  <div class="row">
                      ...
                      <div class="row mb-0">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                          <div class="list-inline text-center">
                            <div class="list-inline-item p-r-30"><i data-feather="arrow-up-circle"
                                class="col-green"></i>
                              <h5 class="mb-0 m-b-0">PKR 45,965</h5>
                    ...
                    <div class="col-lg-3">
                      <div class="row mt-5">
                        ...
                        <div class="col-5 col-xl-5 mb-3">
                          <span class="text-big">PKR 9,857</span>
                        ...
                        <div class="col-5 col-xl-5 mb-3">
                          <span class="text-big">PKR 6,287</span>
                          <sup class="col-green">+09%</sup>
                        </div>
                  ...
                  <div class="col-md-4">
                    <div class="card bg-primary text-white">
                      <div class="card-body text-center">
                        ...
                        <p>
                          @if(Auth::user()->role === 'client')
                            Manage all your hostel rooms
                          @else
                            Manage all hostel rooms in the system
                          @endif
                        </p>
                        <a href="{{ Auth::user()->role === 'client' ? route('admin.client.rooms') : route('admin.rooms.index') }}" class="btn btn-light">
                    ...
                    <div class="card bg-success text-white">
                      <div class="card-body text-center">
                        ...
                        <p>
                          ...
                          @else
                            Create a new room for any client
                          @endif
                        </p>
                        <a href="{{ Auth::user()->role === 'client' ? route('admin.client.rooms.create') : route('admin.rooms.create') }}" class="btn btn-light">
                          <i class="fas fa-arrow-right"></i> Add Room
                        </a>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="card bg-info text-white">
                      <div class="card-body text-center">
                        ...
                        <h5>Room Analytics</h5>
                        <p>
                          @if(Auth::user()->role === 'client')
                            View room performance
                          @else
                            View system-wide room analytics
                          @endif
                        </p>
                        <a href="{{ Auth::user()->role === 'client' ? route('admin.client.rooms') : route('admin.rooms.index') }}" class="btn btn-light">
