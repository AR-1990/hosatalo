...
<!-- avatar  21 Nov 2019 03:54:26 GMT -->
<head>
  <meta charset="UTF-8">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <figure class="avatar mr-2 avatar-xl">
                      <img src="assets-admin/img/users/user-1.png" alt="...">
                    </figure>
                    <figure class="avatar mr-2 avatar-lg">
                      <img src="assets-admin/img/users/user-2.png" alt="...">
                    </figure>
                    <figure class="avatar mr-2">
                      <img src="assets-admin/img/users/user-5.png" alt="...">
                    </figure>
                    <figure class="avatar mr-2 avatar-sm">
                      <img src="assets-admin/img/users/user-3.png" alt="...">
                    </figure>
                    <figure class="avatar mr-2 avatar-xs">
                      <img src="assets-admin/img/users/user-4.png" alt="...">
                    </figure>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-sm-6 col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <figure class="avatar mr-2 avatar-xl">
                      <img src="assets-admin/img/users/user-1.png" alt="...">
                      <img src="assets-admin/img/users/user-5.png" class="avatar-icon" alt="...">
                    </figure>
                    <figure class="avatar mr-2 avatar-lg">
                      <img src="assets-admin/img/users/user-2.png" alt="...">
                      <img src="assets-admin/img/users/user-4.png" class="avatar-icon" alt="...">
                    </figure>
                    <figure class="avatar mr-2">
                      <img src="assets-admin/img/users/user-3.png" alt="...">
                      <img src="assets-admin/img/users/user-3.png" class="avatar-icon" alt="...">
                    </figure>
                    <figure class="avatar mr-2 avatar-sm">
                      <img src="assets-admin/img/users/user-4.png" alt="...">
                      <img src="assets-admin/img/users/user-2.png" class="avatar-icon" alt="...">
                    </figure>
                    <figure class="avatar mr-2 avatar-xs">
                      <img src="assets-admin/img/users/user-5.png" alt="...">
                      <img src="assets-admin/img/users/user-1.png" class="avatar-icon" alt="...">
                    </figure>
                  </div>
                </div>
              </div>
