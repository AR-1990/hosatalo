<!DOCTYPE html>
<html lang=en>
<!-- Mirrored from html.merku.love/hosteller/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Feb 2025 20:43:11 GMT -->
        ...
        <section class="about_benefits section">
            <div class=container>
                <div class="about_benefits-header d-md-flex align-items-center justify-content-between">
                    ...
                    <p class=about_benefits-header_text data-aos=fade-up>Aliquam eleifend mi in nulla. Viverra nibh cras
                        pulvinar mattis nunc</p>
                </div>
                ...
                <div class=about_benefits-video data-aos=fade-in>
                    <picture>
                        <source data-srcset=img/about/video.jpg srcset=img/about/video.jpg><img class=lazy
                ...
                <ul class="rooms_list d-md-flex flex-wrap">
                            ...
                            <div class=media>
                                <picture>
                                    <source data-srcset=img/about/01.jpg srcset=img/about/01.jpg><img class=lazy
                                        ...
                                        class="price h4">PKR 18</span> / 1 night</span>
                            </div>
                            ...
                            <div class=media>
                                <picture>
                                    <source data-srcset=img/about/02.jpg srcset=img/about/02.jpg><img class=lazy
                                        ...
                                        class="price h4">PKR 35</span> / 1 night</span>
                            </div>
                            <div class="main d-md-flex flex-column justify-content-between flex-grow-1"><a
                    ...
                    <li class="rooms_list-item col-md-6 col-xl-4" data-order=3 data-aos=fade-up data-aos-delay=100>
                        <div class="item-wrapper d-md-flex flex-column">
                            <div class=media>
                                <picture>
                                    <source data-srcset=img/about/03.jpg srcset=img/about/03.jpg><img class=lazy
                                        data-src=img/about/03.jpg src=img/about/03.jpg alt=media>
                                </picture><span class="media_label media_label--pricing"><span
                                        class="price h4">PKR 99</span> / 1 night</span>
                            </div>
                            <div class="main d-md-flex flex-column justify-content-between flex-grow-1"><a
                                    class="main_title h4" href=room.html data-shave=true>Apartment with Private
                                    Bathroom</a>
                                <div class=main_amenities><span
                                        class="main_amenities-item d-inline-flex align-items-center"><i
                                            class="icon-twin_bed icon"></i> 1 full bed </span><span
                                        class="main_amenities-item d-inline-flex align-items-center"><i
                                            class="icon-bunk_bed icon"></i> 2 twin beds</span></div><a
                                    class="link link--arrow d-inline-flex align-items-center" href=#>See availability <i
                                        class="icon-arrow_right icon"></i></a>
                            </div>
                        </div>
                ...
                <div class="about_stages-main col-xl-6">
                    ...
                    <ul class=about_stages-main_list>
                        <li class="list-item d-flex align-items-sm-center" data-aos=fade-up>
                            <div class=media><span class=theme-element><svg width=40 height=40 viewBox="0 0 40 40"
                        ...
                        <li class="list-item d-flex align-items-sm-center" data-aos=fade-up data-aos-delay=100>
                            <div class=media><span class=theme-element><svg width=40 height=38 viewBox="0 0 40 38"
                                        fill=none xmlns=http://www.w3.org/2000/svg>
                                        <path fill-rule=evenodd clip-rule=evenodd
                            ...
                            <div class=main>
                                ...
                                <p class=main_text>Vulputate enim nulla aliquet porttitor. Sagittis nisl rhoncus mattis
                                    rhoncus</p>
                            </div>
                        </li>
                    </ul>
                    <div class=wrapper data-aos=fade-up><a
                            class="about_stages-main_btn btn theme-element theme-element--accent" href=#>Choose room</a>
                    </div>
                </div>
                <div class="about_stages-media col-xl-6" data-aos=fade-in>
                    <picture>
                        <source data-srcset=img/about/stages.jpg srcset=img/about/stages.jpg><img class=lazy
            ...
            <div class="container d-xl-flex justify-content-between align-items-center">
                <div class="about_rules-main col-xl-5">
                    ...
                    <ul class=about_rules-main_list>
                        <li class="list-item d-flex align-items-baseline" data-aos=fade-up><i
                                class="icon-check icon"></i> Time of arrival is after 14-00. Time of departure is to
                            12-00</li>
                        <li class="list-item d-flex align-items-baseline" data-aos=fade-up><i
                                class="icon-check icon"></i> Does a settlement take place only at complete payment</li>
                        <li class="list-item d-flex align-items-baseline" data-aos=fade-up><i
                                class="icon-check icon"></i> Is there a settlement in hostel only after the presence of
                            passport</li>
                        <li class="list-item d-flex align-items-baseline important" data-aos=fade-up><i
                                class="icon-check icon"></i> Volutpat odio facilisis mauris sit amet massa vitae tortor
                            condimentum. Quam elementum pulvinar etiam non quam lacus suspendisse. Eget gravida cum
                            sociis natoque</li>
                    </ul>
                </div>
            ...
            <div class=container>
                ...
                <div class="about_faq-main d-grid">
                    <div class=accordion_component-item>
                        <div class="item-wrapper d-flex flex-column justify-content-between">
                            <h4 class="accordion_component-item_header d-flex justify-content-between align-items-center collapsed"
                                data-bs-toggle=collapse data-bs-target=#item-1 aria-expanded=true>How do you choose the
                                right hostel? <span class=wrapper><i
                                        class="icon-chevron_down icon transform"></i></span></h4>
                            <div id=item-1 class="accordion-collapse collapse show">
                                <div class=accordion_component-item_body>Consequat interdum varius sit amet mattis
                                    vulputate enim nulla. Posuere morbi leo urna molestie at element eu facilisis sed
                                    excepteur sint occaecat</div>
                            </div>
                        </div>
                    </div>
                    <div class=accordion_component-item>
                        <div class="item-wrapper d-flex flex-column justify-content-between">
                            <h4 class="accordion_component-item_header d-flex justify-content-between align-items-center"
                                data-bs-toggle=collapse data-bs-target=#item-2 aria-expanded=true>How many people are in
                                a hostel room? <span class=wrapper><i
                                        class="icon-chevron_down icon transform"></i></span></h4>
                    ...
                    <div class=accordion_component-item>
                        <div class="item-wrapper d-flex flex-column justify-content-between">
                            <h4 class="accordion_component-item_header d-flex justify-content-between align-items-center collapsed"
                                data-bs-toggle=collapse data-bs-target=#item-3 aria-expanded=true>Are there private
                                rooms in Hostels? <span class=wrapper><i
                                        class="icon-chevron_down icon transform"></i></span></h4>
                    ...
                    <div class=accordion_component-item>
                        <div class="item-wrapper d-flex flex-column justify-content-between">
                            <h4 class="accordion_component-item_header d-flex justify-content-between align-items-center collapsed"
                                data-bs-toggle=collapse data-bs-target=#item-4 aria-expanded=true>How do I keep my
                                things safe in a hostel? <span class=wrapper><i
                                        class="icon-chevron_down icon transform"></i></span></h4>
                    ...
                    <div class=accordion_component-item>
                        <div class="item-wrapper d-flex flex-column justify-content-between">
                            <h4 class="accordion_component-item_header d-flex justify-content-between align-items-center collapsed"
                                data-bs-toggle=collapse data-bs-target=#item-5 aria-expanded=true>How do you stay safe
                                in a hostel? <span class=wrapper><i class="icon-chevron_down icon transform"></i></span>
                            </h4>
                    ...
                    <div class="about_faq-main_card accent d-flex flex-column justify-content-between">
                        ...
                        <p class="text flex-grow-1">Diam phasellus vestibulum lorem sed risus ultricies tristique</p><a
                            class="btn theme-element theme-element--light" href=contacts.html>Ask a question</a>
                    </div>
                </div>
            </div>
        </section>
        <section class="about_footer section">
            <div class="container d-md-flex flex-wrap justify-content-between">
                <div class="about_footer-block about_footer-block--quote d-md-flex align-items-center">
                    ...
                    <div class=main><q class="main_quote h4" data-aos=fade-left>Mauris a diam maecenas sed enim ut sem.
                            Scelerisque in dictum non consectetur a erat nam. Commodo viverra maecenas accumsan
                            lacus</q>
                        <div class="main_author d-flex flex-column flex-md-row"><span class=name data-aos=fade-left
                                data-aos-delay=50>Johnathan Jennings</span> <span class="profession h6"
                                data-aos=fade-left data-aos-delay=100>Founder of the hostel “Hosteller”</span></div>
                    </div>
                </div>
                <div class="about_footer-block about_footer-block--booking d-flex"><span class=border
                        data-aos=fade-up></span>
                    <div class=content>
                        <h4 class=about_footer-block_header data-aos=fade-left>Are you looking for an apartment?</h4>
                        <p class=about_footer-block_text data-aos=fade-left data-aos-delay=50>Tellus mauris a diam
                            maecenas sed enim. Facilisi etiam dignissim diam quis enim lobortis scelerisque fermentum
                        </p>
                        <div class=wrapper data-aos=fade-left data-aos-delay=100><a
                                class="theme-element theme-element--accent btn" href=#>View rooms</a></div>
                    </div>
                </div>
                <div
                    class="about_footer-block about_footer-block--subscribe d-lg-flex flex-column justify-content-between">
                    <h4 class=about_footer-block_header data-aos=fade-left>Newsletter</h4>
                    <p class="about_footer-block_text flex-grow-1" data-aos=fade-left data-aos-delay=50>Urna id volutpat
                        lacus laoreet. Viverra vitae congue eu consequat ac</p>
                    <form class="form d-flex" action=# method=post data-type=subscribe data-aos=fade-left
                        data-aos-delay=100><input class="field required" type=text data-type=email
...
<!-- Mirrored from html.merku.love/hosteller/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Feb 2025 20:43:12 GMT -->
