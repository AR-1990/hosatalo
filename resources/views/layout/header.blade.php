        ...
        <div class="container position-relative d-flex justify-content-between align-items-center">
            <a class="brand d-flex align-items-center" href="{{ route('index') }}">
                ...
                <span class="brand_name">
                    <img src="{{ asset('img/index/header-logo-removebg-preview.png') }}" alt="Hosteller">
                </span>
            </a>
                ...
                <nav class="header_nav">
                    <ul class="header_nav-list">
                        <li class="header_nav-list_item">
                            <a class="nav-item" href="{{ route('index') }}" data-page="home">Home</a>
                        </li>
                        <li class="header_nav-list_item">
                            <a class="nav-item" href="{{ route('about') }}" data-page="about">About</a>
                        </li>
                        <li class="header_nav-list_item dropdown">
                            <a class="nav-link dropdown-toggle d-inline-flex align-items-center" href="{{ route('rooms') }}"
                                data-bs-toggle="collapse" data-bs-target="#roomMenu" aria-expanded="false"
                                aria-controls="roomMenu" data-page="rooms">
                                Rooms <i class="icon-chevron_down--entypo icon"></i>
                            </a>
                            <div class="dropdown-menu collapse" id="roomMenu">
                                <ul class="dropdown-list">
                                    <li class="list-item">
                                        <a class="dropdown-item nav-item" data-page="room" href="{{ route('rooms.detail', 1) }}">Single room</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="header_nav-list_item dropdown">
                            <a class="nav-link dropdown-toggle d-inline-flex align-items-center" href="{{ route('news') }}"
                                data-bs-toggle="collapse" data-bs-target="#newsMenu" aria-expanded="false"
                                aria-controls="newsMenu" data-page="news">
                                News <i class="icon-chevron_down--entypo icon"></i>
                            </a>
                            <div class="dropdown-menu collapse" id="newsMenu">
                                <ul class="dropdown-list">
                                    <li class="list-item">
                                        <a class="dropdown-item nav-item" data-page="post" href="{{ route('news') }}">Single post</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="header_nav-list_item">
                            <a class="nav-item" href="{{ route('faq') }}" data-page="faq">FAQ</a>
                        </li>
                        <li class="header_nav-list_item">
                            <a class="nav-item" href="{{ route('contacts') }}" data-page="contacts">Contacts</a>
                        </li>
                    </ul>
                </nav>
