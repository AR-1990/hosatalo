            ...
            <div class="footer_main d-sm-flex flex-wrap flex-lg-nowrap justify-content-between">
                <div class="footer_main-block footer_main-block--about col-sm-7 col-lg-auto d-flex flex-column">
                    <a class="brand d-flex align-items-center" href="{{ route('index') }}">
                        <span class="brand_logo">
                            <img src="{{ asset('img/index/header-logo-removebg-preview.png') }}" alt="Hosteller" style="height: 30px;">
                        </span>
                ...
                <div class="footer_main-block footer_main-block--nav col-sm-6 col-lg-auto">
                    ...
                    <ul class="footer_main-block_nav d-flex flex-lg-column">
                        <li class="list-item">
                            <a class="link underlined underlined--white nav-item" data-page="home" href="{{ route('index') }}">Home</a>
                        </li>
                        <li class="list-item">
                            <a class="link underlined underlined--white nav-item" data-page="about" href="{{ route('about') }}">About</a>
                        </li>
                        <li class="list-item">
                            <a class="link underlined underlined--white nav-item" data-page="rooms" href="{{ route('rooms') }}">Rooms</a>
                        </li>
                        <li class="list-item">
                            <a class="link underlined underlined--white nav-item" data-page="hostels" href="{{ route('hostels') }}">Hostels</a>
                        </li>
                        <li class="list-item">
                            <a class="link underlined underlined--white nav-item" data-page="news" href="{{ route('news') }}">News</a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="footer_copyright">
            <div class="container">
                <p class="footer_copyright-text">
                    ...
                    <span class="linebreak">Copyright © All rights reserved Copyrights 2025</span>
                </p>
            </div>
        </div>
    </footer>